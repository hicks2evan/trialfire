...
On Windows: https://dev.mysql.com/doc/refman/8.0/en/windows-installation.html
...
To build the final jar and optimize the trialfire application for production, run:
