...
public class MessageResourceIT {
    ...
    private static final Integer DEFAULT_SENDAFTER = 1;
    private static final Integer UPDATED_SENDAFTER = 2;
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getSendafter()).isEqualTo(DEFAULT_SENDAFTER);
    }
    ...
    public void getAllMessages() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].sendafter").value(hasItem(DEFAULT_SENDAFTER)));
    }
    ...
    public void getMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages/{id}", message.getId()))
            ...
            .andExpect(jsonPath("$.sendafter").value(DEFAULT_SENDAFTER));
    }
    @Test
    @Transactional
    ...
    public void updateMessage() throws Exception {
        ...
        assertThat(testMessage.getSendafter()).isEqualTo(UPDATED_SENDAFTER);
    }
